...
RipeDataParser.prototype.ripe_response_parse = function(json,start,end) {
	...
	var data = json['data'];
	this.rrc_map = {}, this.states = {}, this.events = [], this.resources = [], this.targets = [], this.last_date = data['query_starttime'];
	this.asn_distributions = [], this.asn_set = [], this.rrc_set = [], this.asn_freqs={}, this.asn_sumfreqs={}, this.asn_avgfreqs={}, this.asn_varfreqs={}, this.asn_stdev={};
	//fetch nodes and cp
